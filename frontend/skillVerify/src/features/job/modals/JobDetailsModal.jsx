  ...
  return createPortal(
    <div className="fixed inset-0 z-[999]   flex items-center md:items-center justify-center   ">
      ...
      >
        ...
        {/* content */}
        <div className="p-3 md:p-6 border ">
          {/* header */}
          ...
          <div className="flex flex-wrap bg-gradient-to-r from-emerald-500 to-cyan-400 rounded-md text-sm text-gray-900 p-3">
            <div className="flex  flex-col justify-center   space-y-1 ">
              ...
              <span className="flex items-center gap-1 text-[11px] md:text-base">
                <Users className="md:w-4 md:h-4 w-2 h-2" /> Vacancies:{" "}
                {noOfOpenings}
              </span>
              <span className="flex items-center gap-1 text-[11px] md:text-base">
                <ClipboardList className="md:w-4 md:h-4 w-2 h-2" />{" "}
                Short-listed: {shortlisted}
              </span>
              <span className="flex items-center gap-1 text-[11px] md:text-base">
                <Clock className="md:w-4 md:h-4 w-2 h-2"></Clock>
                {postedAgo}
              </span>
            </div>
            <div></div>
          ...
          {/* description */}
          <h3 className="mt-6 mb-1 text-[12px]   md:text-base font-semibold">
            Job Description
          </h3>
